...
% \begin{multicols}{1}
%\lstinputlisting[language=java,caption={Servidor }]{code/client/Server.java}
%\lstinputlisting[language=java,caption={Main cliente }]{code/client/CMain.java}
%\lstinputlisting[language=java,caption={Cliente }]{code/client/Client.java}
%\lstinputlisting[language=java,caption={Server Interface }]{code/client/MC823Server.java}
%\lstinputlisting[language=java,caption={Struct de compromissos }]{code/client/Opr.java}
