...
\subsection{Inserção de compromisso}
...
Um compromisso é inserido ordenadamente na agenda se não existir um
...
Aplicamos o cálculo de tempo ao programa principal de
  ...
  \begin{table}[h!]
    ...
    \end{center}
    \vspace{-5mm}
    \caption{Conexão, login na conta, remoção de compromissos
  ...
  \begin{table}[h!]
    ...
    \end{center}
    \vspace{-5mm}
    \caption{Conexão, login na conta, ver compromissos do
